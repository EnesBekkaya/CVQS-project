package com.cvqs.securityservice.aspects;
...
public class ServiceAspect {
    ...
    @Around("execution(* com.cvqs.securityservice.service.*.*(..)) || execution(* com.cvqs.securityservice.controller.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.cvqs.securityservice.service.*.*(..)) || execution(* com.cvqs.securityservice.controller.*.*(..))", throwing = "ex")
