package com.cvqs.terminalservice.aspects;
...
public class ServiceAspect {
    ...
    @Around("execution(* com.cvqs.terminalservice.service.concretes.*.*(..)) || execution(* com.cvqs.terminalservice.controller.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.cvqs.terminalservice.service.concretes.*.*(..)) || execution(* com.cvqs.terminalservice.controller.*.*(..))", throwing = "ex")
